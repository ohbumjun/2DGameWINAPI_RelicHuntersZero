...
#define NORMAL_MONSTER_ATTACK_DISTANCE 350.f
#define MEDIUM_MONSTER_ATTACK_DISTANCE 450.f
#define HARD_MONSTER_ATTACK_DISTANCE   500.f
#define BOSS_MONSTER_ATTACK_DISTANCE   2000.f

// Monster Dash Distance
#define NORMAL_MONSTER_DASH_DISTANCE 500.f
#define MEDIUM_MONSTER_DASH_DISTANCE 650.f
#define KAMIKAZE_MONSTER_DASH_DISTANCE	800.f
#define BOSS_MONSTER_DASH_DISTANCE 1000.f

// Monster Move Speed
#define NORMAL_MONSTER_MOVE_SPEED 150.f
#define MEDIUM_MONSTER_MOVE_SPEED 200.f
