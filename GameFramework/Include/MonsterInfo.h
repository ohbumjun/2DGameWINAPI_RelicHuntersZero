...
#define MEDIUM_MONSTER_ATTACK_DISTANCE 300.f
#define HARD_MONSTER_ATTACK_DISTANCE 400.f
#define BOSS_MONSTER_ATTACK_DISTANCE 2000.f

// Monster Dash Distance
#define NORMAL_MONSTER_DASH_DISTANCE 500.f
#define MEDIUM_MONSTER_DASH_DISTANCE 600.f
#define HARD_MONSTER_DASH_DISTANCE 700.f
