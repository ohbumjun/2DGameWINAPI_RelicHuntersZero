...
#define NORMAL_MONSTER_ATTACK_DISTANCE 100.f
#define MEDIUM_MONSTER_ATTACK_DISTANCE 150.f
#define HARD_MONSTER_ATTACK_DISTANCE   200.f
#define BOSS_MONSTER_ATTACK_DISTANCE   2000.f

// Monster Dash Distance
#define NORMAL_MONSTER_DASH_DISTANCE 300.f
#define MEDIUM_MONSTER_DASH_DISTANCE 350.f
