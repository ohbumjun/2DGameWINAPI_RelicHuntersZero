...
void CCharacterManager::InitCharAbilityInfos()
{
	...
	AssCharInfo.Attack = 180, AssCharInfo.Armor = 60, AssCharInfo.HP = 400,
		...
		AssCharInfo.Stemina = 6.f, AssCharInfo.SteminaMax = 6.f, AssCharInfo.MoveSpeed = 250.f,
	...
	BiuCharInfo.Attack = 210, BiuCharInfo.Armor = 80, BiuCharInfo.HP = 600,
		...
		BiuCharInfo.Stemina = 3.f, BiuCharInfo.SteminaMax = 3.f, BiuCharInfo.MoveSpeed = 170.f,
	...
	JimmyCharInfo.Attack = 170, JimmyCharInfo.Armor = 80, JimmyCharInfo.HP = 500,
		...
		JimmyCharInfo.Stemina = 5.f, JimmyCharInfo.SteminaMax = 5.f, JimmyCharInfo.MoveSpeed = 210.f,
	...
	PinkyCharInfo.Attack = 190, PinkyCharInfo.Armor = 70, PinkyCharInfo.HP = 450,
		...
		PinkyCharInfo.Stemina = 3.f, PinkyCharInfo.SteminaMax = 3.f, PinkyCharInfo.MoveSpeed = 300.f,
	...
	RaffCharInfo.Attack = 150, RaffCharInfo.Armor = 50, RaffCharInfo.HP = 450,
		...
		RaffCharInfo.Stemina = 9.f, RaffCharInfo.SteminaMax = 9.f, RaffCharInfo.MoveSpeed = 300.f,
