...
CPlayer::CPlayer() : m_RunEnable(false),
					 m_DashEnable(false),m_TargetEnable(false),m_DashTime(0.f),m_TeleportEnable(false),m_TelePortTime(0.f),m_TeleportObj{},m_TeleportPos(Vector2(0.f, 0.f)),m_DeathAnimationTime(0.f),
					m_MonsterCollideTime(0.f),
					 m_UIPause(nullptr),
					 m_PlayerDeath(false),m_HPBarWidget(nullptr),m_MPBarWidget(nullptr),m_NameWidget(nullptr),m_SteminaBarWidget(nullptr),
					m_HpPotionInv(0),m_MpPotionInv(0),m_ShieldInv(0),m_SkillTime(0.f),m_SkillTimeMax(20.f),m_MonsterKilled(0),
					m_SkillEnable(false),
